...
public class Borrowable extends LibraryResource{  //This interface should be implemented by the Book and CoursePack classes
	...
	/*
	 ...
	 if there are pending requests for this resource, automatically issue it to the first requester
	 return return true if successful else return false
	 */
